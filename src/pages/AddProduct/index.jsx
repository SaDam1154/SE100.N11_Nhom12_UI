        ...
        <div className="container">
            <div className="w-full">
                <div className="flex flex-row mt-4">
                    <div className="w-1/2 flex flex-col mr-8 mt-3 italic text-lg space-y-4" >
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" className="text-input px-2 py-1" id="type"/>
                        </div>
    
                        <div className="flex flex-col">
                            <label className="font-semibold mb-1 text-xl" htmlFor="quantity">Số lượng</label>
                            <input type="number" defaultValue={1} className="text-input px-2 py-1" id="quantity" required/>
                        </div>
                    </div>
    
                    <div className="w-1/2 flex-col ml-4 items-center justify-items-center ">
                        <div className="h-60 rounded-xl bg-gray-100 border-dashed border-2 border-cyan-300" >
                            {img && (
                ...
                <div className="flex flex-row mt-4 italic text-lg">
                    <div className="basis-1/2 flex flex-col mr-8 mt-3" >
                    ...
                    <div className="basis-1/2 flex flex-col ml-4 mt-3" >
                        ...
                        <div className="relative">
                            <input type="text" id="value" defaultValue={0} className="w-full text-input px-2 py-1" required/>
                            <label htmlFor="value" className="lb-value absolute top-0 right-0 px-[6%] py-1 text-gray-600 text-lg select-none">VNĐ</label>
                        </div>
                    </div>
                </div>
    
                <div className="w-1/2 flex float-right flex-row mt-6 ml-4px pl-4">
