    ...
    return (
        <div>
            <div className="flex space-x-4">
                ...
                <div className="flex grow">
                    <div className="mr-2 flex grow">
                        <input type="text" className="text-input grow" placeholder="Tìm kiếm chức vụ" />
            ...
            <table className="mt-4 w-full">
                ...
                <tbody>
                    {rules.map((rule) => (
                        <tr key={rule.id} className="cursor-pointer border-b border-slate-200 hover:bg-slate-100">
