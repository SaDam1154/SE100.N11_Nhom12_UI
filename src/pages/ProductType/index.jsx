            ...
            <table className="mt-8 w-full">
                <thead className="w-full rounded bg-blue-500 text-white">
                    <tr className="flex h-11 w-full">
                        <th className="flex w-80 items-center justify-start px-4">
                            STT
                        </th>
                        ...
                        <th className="flex w-48 items-center justify-center px-2">
                            Ngày thêm
                        </th>
                ...
                >
                    {productTypes
                        ...
                        ?.map((product, index) => (
                            ...
                            >
                                <td
                                    className="flex w-80 items-center justify-start px-6 py-2"
